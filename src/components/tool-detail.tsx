 ...
 *
 * Split out of the page so the same markup can render a listing that does not
 * exist yet: the submission review screen previews an unpublished draft through
 * this component, which is the only way to be sure that what an admin approves
 * is what readers will get. The page keeps the parts that are page-shaped -
 * metadata, static params and the JSON-LD graph, which arrives here as `jsonLd`
 * so the script tag stays exactly where it was in the markup.
 *
